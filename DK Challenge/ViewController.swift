...
//        getTimestampData()
    ...
    func searchContinuityAboveValue(array: [Int], sum: Int) -> Bool {
        var lowIndex = 0
    ...
    func backSearchContinuityWithinRange(array: [Int], sum: Int) -> Bool {
    ...
    func searchMultiContinuityWithinRange(array: [Int], sum: Int) -> Bool {
